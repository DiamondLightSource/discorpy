...
losa.save_plot_points(output_base + "/hor_points.png", list_points_hor_lines, height, width)
losa.save_plot_points(output_base + "/ver_points.png", list_points_ver_lines, height, width)
...
losa.save_plot_image(output_base + "/hor_lines.png", list_hor_lines, height, width)
losa.save_plot_image(output_base + "/ver_lines.png", list_ver_lines, height, width)
...
list_fact = proc.calc_coef_backward(list_hor_lines, list_ver_lines, xcenter, ycenter, num_coef)
